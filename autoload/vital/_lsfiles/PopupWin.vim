...
execute join(['function! vital#_lsfiles#PopupWin#import() abort', printf("return map({'enhance_menufilter': ''}, \"vital#_lsfiles#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
